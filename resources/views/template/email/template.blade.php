			...
			<tr>
				<td align="left" class="textContent">
					<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
						{{ ucwords('silakan klik tombol dibawah. jika tidak bisa, salin alamat ini dan buka di browser : ') }}{{ $link }}
					</div>
				</td>
			</tr>
		</table>
...
<tr>
	<td align="center" valign="top" class="textContent">
		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">{{ $header }}</h1>
		<br>
		<div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">{{ ucwords('silakan klik tombol dibawah. jika tidak bisa, salin alamat ini dan buka di browser : ') }}{{ $link }}</div>
	</td>
</tr>

<tr>
	<td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px; background-color: red">
		<a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="{{ $link }}" target="_blank">KLIK DISINI</a>
	</td>
</tr>
</table>
<!-- // CONTENT TABLE -->
